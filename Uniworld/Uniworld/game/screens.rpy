...
screen navigation():
    ...
    hbox:
        ...
        textbutton _("Выйти") action Show("confirmbutton")
...
screen main_menu():
    ...
    vbox:
        xpos 280
        ypos 330
        textbutton _("Новая игра") action Start() at button1
        ...
        textbutton _("О нас") action ShowMenu("about") at button5
        textbutton _("Выйти") action Quit(confirm=not main_menu) at button6
...
screen confirmbutton():
    ...
    frame:
        ...
        vbox:
            ...
            label _("Вы действительно хотите выйти?"):
                style "confirm_prompt"
                xalign 0.5
